...
Для начала работы с системой проживания, перейдите в своем проекте: **Прочее > Настройки**.
...
.. hint:: Если ваше мероприятие предусматривает вариант участия «без проживания», добавьте его в типы размещения с требуемой ценой за место (можно «0»), чтобы «гости» без ночевки могли указать его в своих заявках.
...
.. attention:: Название комнат будет видно тем, кто отмечен как проживающий в этой комнате. Избегайте спойлеров для игроков!
