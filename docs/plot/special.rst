...
После имени персонажа в именительном падеже (как в сетке ролей) будут показаны имя и контакты (почта, телефон, социальные сети) игрока, указанные им в профиле. Если игрок не утвержден, то после персонажа будет отметка *«нет игрока»*. ::
