...
.. attention:: С этой страницы также можно `создавать сюжеты </plot/creating-input.html>`_, но обратите внимание, что сюжеты и вводные, созданные с этой страницы, **не будут** автоматически привязаны к данной группе.
