...
Описание персонажа может быть привязано к любому полю **персонажа**, которое имеет `тип «Текст» <http://docs.joinrpg.ru/ru/latest/fields/type_fields.html>`_. К полям заявки его привязать нельзя. 
