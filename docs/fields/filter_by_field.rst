...
Поля персонажа типов «выбор» и «мультивыбор» автоматически формируют `специальные группы </groups/hidden-group.html#id5>`_, отображающиеся как часть сетки ролей.
